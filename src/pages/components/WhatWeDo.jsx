...
// --- SVG Icons with uniform color ---
const iconClass = "w-full h-full text-[#FF9B4B]"; // Apply the orange color
...
const ServiceCard = ({ icon, title, description, imageSrc, onArrowClick }) => {
  return (
    <div className="bg-white rounded-xl shadow-md p-6 flex flex-col relative overflow-hidden">
...
const WhatWeDo = () => {
  ...
  return (
    <>
      <PageWrapper>
        <div className="flex flex-col px-10 md:flex-row justify-between items-start md:items-end mb-12">
          <div>
