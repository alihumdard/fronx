            ...
            <div className="relative w-full">
              ...
              z-10 pointer-events-none"
                ...
                <div className="max-w-full mx-auto pt-14 flex justify-center">
                    <img src="/images/web1.jpg" alt="" className="rounded-lg shadow-md" />
                </div>
                ...
                <div className="py-20 flex items-center justify-center relative bg-cover bg-center " style={{ backgroundImage: "url('/images/bg.png')" }}>
                    {/* Overlay gradient */}
